...
@implementation RankingListCell2
...
{
    static NSString *idenifier = @"RankingListCell2";
    RankingListCell2 *cell = [tableView dequeueReusableCellWithIdentifier:idenifier];
    if (cell == nil)
    {
        cell = [[RankingListCell2 alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:idenifier];
...
- (void)drawView
{
    ...
    nameLabel.text = @"张先生秒杀了9999999999元";
