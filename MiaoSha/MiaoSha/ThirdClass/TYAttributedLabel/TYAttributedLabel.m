...
{
    return [_textContainer getSizeWithFramesetter:nil maxSize:maxSize];
}
...
- (void)appendTextAttributedString:(NSAttributedString *)attributedText
{
    ...
    {
        attributedText = (NSAttributedString *)[[[NSMutableAttributedString alloc] initWithAttributedString:attributedText] setAttributedStringLineSpace:0.0];
    }
