 ...
 *  设置行间距（自己写的方法）
 */
- (NSMutableAttributedString *)setAttributedStringLineSpace:(CGFloat)lineSpace
{
    ...
    NSDictionary *ats = @{
                          NSFontAttributeName : font?[UIFont systemFontOfSize:font.pointSize]:[UIFont systemFontOfSize:15],
                          NSParagraphStyleAttributeName : paragraphStyle,
                          };
    [self addAttributes:ats range:NSMakeRange(0, self.length)];
